//===- InsertCompSimpTestFunctions.h - Aggressive dead code elimination ----------------*- C++ -*-===//
//
...
#ifndef LLVM_TRANSFORMS_SCALAR_INSERTCOMPSIMPTESTFUNCTIONS_H
#define LLVM_TRANSFORMS_SCALAR_INSERTCOMPSIMPTESTFUNCTIONS_H
...
struct InsertCompSimpTestFunctionsPass : PassInfoMixin<InsertCompSimpTestFunctionsPass> {
  PreservedAnalyses run(Module &F, ModuleAnalysisManager &);
};

} // end namespace llvm

#endif // LLVM_TRANSFORMS_SCALAR_INSERTCOMPSIMPTESTFUNCTIONS_H
