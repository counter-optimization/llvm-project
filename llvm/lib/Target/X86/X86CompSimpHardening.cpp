...
void X86_64CompSimpMitigationPass::insertSafeAdd64mi32Before(MachineInstr *MI) {
  ...
  auto I1 = BuildMI(*MBB, *MI, DL, TII->get(X86::MOV64ri32), X86::R14).add(MOp6);
  auto I2 = BuildMI(*MBB, *MI, DL, TII->get(X86::MOV64rm), X86::R13).add(MOp1).add(MOp2).add(MOp3).add(MOp4).add(MOp5);
